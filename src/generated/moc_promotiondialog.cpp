...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PromotionDialog_t, stringdata) + ofs \
...
const QMetaObject PromotionDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PromotionDialog.data,
      qt_meta_data_PromotionDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PromotionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PromotionDialog.stringdata))
        return static_cast<void*>(const_cast< PromotionDialog*>(this));
