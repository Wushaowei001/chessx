...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AboutDlg_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 31, 6) // "reject"
    ...
    "AboutDlg\0restoreLayout\0\0accept\0reject"
};
...
void *AboutDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AboutDlg.stringdata))
