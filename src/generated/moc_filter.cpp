...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filter::searchProgress)) {
                *result = 0;
            }
        }
        {
            typedef void (Filter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filter::searchFinished)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Filter::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Filter.data,
