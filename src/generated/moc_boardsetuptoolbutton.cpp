...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BoardSetupToolButton_t, stringdata) + ofs \
...
void BoardSetupToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BoardSetupToolButton *_t = static_cast<BoardSetupToolButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (BoardSetupToolButton::*_t)(QWidget * , QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardSetupToolButton::signalDragStarted)) {
                *result = 0;
            }
        }
        {
            typedef void (BoardSetupToolButton::*_t)(Piece );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardSetupToolButton::signalClicked)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject BoardSetupToolButton::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_BoardSetupToolButton.data,
      qt_meta_data_BoardSetupToolButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BoardSetupToolButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BoardSetupToolButton.stringdata))
        return static_cast<void*>(const_cast< BoardSetupToolButton*>(this));
