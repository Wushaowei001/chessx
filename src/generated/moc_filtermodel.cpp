...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FilterModel_t, stringdata) + ofs \
...
const QMetaObject FilterModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_FilterModel.data,
      qt_meta_data_FilterModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FilterModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FilterModel.stringdata))
